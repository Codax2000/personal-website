...
import overall from '../img/cadathon/overall.JPG';

// gallery pictures
import fire from '../img/cadathon/fire.JPG';
import front from '../img/cadathon/front-controls.PNG';
import locker from '../img/cadathon/locker-open.PNG';
import open from '../img/cadathon/open-up.PNG';
import seat from '../img/cadathon/seat.JPG';
import suspension from '../img/cadathon/suspension.JPG';
import wheel from '../img/cadathon/wheel-front.JPG';
  ...
  return (
    <Container fluid className="report-article">
      <Container fluid className="report-article">
        ...
        <ArticleWithImage title={articles[0]['title']} content={articles[0]['content']}
          graph={articles[0]['images'][0]['url']} caption={articles[0]['images'][0]['caption']}
      ...
      <Container>
        ...
        <Container id="gallery" className="d-flex justify-content-between flex-wrap">
          {
            gallery.map((item, i) => <div className="m-2">
